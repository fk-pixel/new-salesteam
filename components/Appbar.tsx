...
export default function Appbar() {
  ...
  const messages = MESSAGES.map((m) => (
    ...
    >
      <Flex gap="sm" align="center">
        ...
        <Flex gap={1}>
          <TextArea fz="sm" fw={600}>
            {m.first_name} {m.last_name}
          </TextArea>
          <TextArea lineClamp={2} fz="xs" c="dimmed">
            {m.message}
          </TextArea>
        </Flex>
      </Flex>
  ...
  const [sidebarOpen, setSidebatOpen] = React.useState(false);
        ...
        <Flex justify="space-between">
          <Flex gap={0}>
            <Tooltip label="Toggle side navigation">
              <Button
                ...
                icon={
                  sidebarOpen ? <NodeCollapseOutlined /> : <ExpandOutlined />
                }
              ></Button>
            </Tooltip>
            {/* <Burger
          ...
          <Flex>
            ...
            <Tooltip label="Logout">
              <Button icon={<PoweroffOutlined size={12} />}></Button>
            </Tooltip>
            <Menu shadow="lg" width={200}>
              ...
              <Menu.Dropdown>
                ...
                <Menu.Item
                  leftSection={<SunOutlined size={16} />}
                  onClick={() => console.log('setColorScheme("light")')}
                >
                  Light
                </Menu.Item>
                <Menu.Item
                  leftSection={<MoonFilled size={16} />}
                  onClick={() => console.log('setColorScheme("dark")')}
                >
                  Dark
                </Menu.Item>
              </Menu.Dropdown>
            ...
            <div className="flex flex-col gap-1 w-full">
              {links.map((link, index) => (
                <Link key={index} href={link.href}>
                  <Button
                    variant={pathname === link.href ? "secondary" : "primary"}
                    icon={link.icon}
                    className="w-full"
                  >
